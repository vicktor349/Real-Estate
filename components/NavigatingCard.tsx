...
const NavigatingCard = ({ step, title, text }: NavigatingCardProps) => {
    return (
        <div className=''>
            ...
            <div className='h-[220px] 2xl:h-[250px] ssm:h-[200px] border border-[#262626] rounded-r-xl rounded-bl-xl p-5 2xl:p-8 grid gap-y-3 2xl:gap-y- bg-navigateBackground'>
